...
class table_tom_tongcheng_pinglun_reply extends discuz_table{
	public function __construct() {
        parent::__construct();
		$this->_table = 'tom_tongcheng_pinglun_reply';
		$this->_pk    = 'id';
	}
    ...
    public function delete_pinglun_id($ping_id) {
		return DB::query("DELETE FROM %t WHERE ping_id=%d ", array($this->_table, $ping_id));
	}
