...
class table_tom_tcshop_clerk extends discuz_table{
	public function __construct() {
        parent::__construct();
		$this->_table = 'tom_tcshop_clerk';
		$this->_pk    = 'id';
	}
    ...
    public function delete_by_tcshop_id($tcshop_id) {
		return DB::query("DELETE FROM %t WHERE tcshop_id=%d", array($this->_table, $tcshop_id));
	}
